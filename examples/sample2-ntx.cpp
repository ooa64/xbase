/*  $Id: sample2-ntx.cpp,v 1.3 2000/09/20 20:34:02 dbryson Exp $
...
main()
{
  ...
  f = -2.1; 
  MyFile.PutFloatField( f1, f );
  MyFile.PutFloatField( "FLOAT2", -2.1 );
  ...
  f = 3.21; 
  MyFile.PutFloatField( f1, f );
  MyFile.PutFloatField( "FLOAT2", 3.21 );
  ...
  f = 4.321; 
  MyFile.PutFloatField( f1, f );
  MyFile.PutFloatField( "FLOAT2", 4.321 );
